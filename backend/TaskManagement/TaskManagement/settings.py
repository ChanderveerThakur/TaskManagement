...
# Load environment variables from .env (check backend directory and project directory)
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-lub)zf!jkts@7n0d!_#yx349xrj@35sq-3xdp_x6@0tbs-g_7v')
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'TaskManagement.authentication.CsrfExemptSessionAuthentication',
    ],
}
